	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-4">
				<div class="panel panel-default">
					<div class="panel-body" id="panel">
						<h4 class="title">Masukkan Data Barang Terjual</h4>
					</div>
					<div class="panel-body">
						<form action="<?php echo base_url()?>/index.php/home/input_terjual" method="post">
							<div class="row">
								<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Barang yang terjual</label>
			...
			<div class="col-md-8">
				<div class="panel panel-default">
					<div class="panel-body" id="panel">
						<h4 class="title">List Data Barang Terjual</h4>
					</div>
					<div class="panel-body" id="panel">
